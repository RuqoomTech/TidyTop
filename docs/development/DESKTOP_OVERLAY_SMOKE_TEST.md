...
7. Press **Save**, close the app, run it again, and confirm the layout loads.
8. Open a normal application window and confirm it appears above TidyTop.
9. Minimize all normal windows and confirm TidyTop is visible again on the desktop.

## Known limitations for this pass

- Native Windows desktop icons are not hidden or replaced yet.
- SmartBoxes cannot yet be dragged or resized from the UI.
